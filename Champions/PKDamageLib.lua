...
local function KSante_WDmg(source, target)
	...
	local Dmg = ({25, 35, 45, 55, 65})[lvl] + 0.5 * source.total_attack_damage + ({0.0425, 0.045, 0.0475, 0.05, 0.0525})[lvl] * target.max_health	
	if source:has_buff("KSanteRTransform") then
		Dmg = ({110, 170, 230, 290, 350})[lvl] + 0.5 * source.total_attack_damage + ({0.0825, 0.085, 0.0875, 0.09, 0.0925})[lvl] * target.max_health
	end
	return Dmg
end
...
local DamageLibTable = {
  ...
  ["Ahri"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({40, 65, 90, 115, 140})[level] + 0.45 * source.ability_power end},
    {Slot = "Q", Stage = 2, DamageType = 3, Damage = function(source, target, level) return ({40, 65, 90, 115, 140})[level] + 0.45 * source.ability_power end},
  ...
  ["Annie"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 115, 150, 185, 220})[level] + 0.8 * source.ability_power end},
  ...
  ["Blitzcrank"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({105, 155, 205, 255, 305})[level] + 1.2 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return 1.75 * source.total_attack_damage + 0.25 * source.ability_power end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({275, 400, 525})[level] + 1.25 * source.ability_power end},
  },
  ...
  ["Belveth"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({10, 15, 20, 25, 30})[level] + 1.1 * source.total_attack_damage end},
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 110, 150, 190, 230})[level] + 1.25 * source.ability_power + source.bonus_attack_damage end},
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({8, 11, 14, 17, 20})[level] + 0.06 * source.total_attack_damage end}, --Per Hit
    {Slot = "R", Stage = 1, DamageType = 3, Damage = function(source, target, level) return ({150, 200, 250})[level] + source.ability_power + (0.25 * (target.max_health-target.health)) end},
  },  
  ...
  ["Caitlyn"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({50, 90, 130, 170, 210})[level] + ({1.25, 1.45, 1.65, 1.85, 2.05})[level] * source.total_attack_damage end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 130, 180, 230, 280})[level] + 0.8 * source.ability_power end},
  ...
  ["Camille"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({80, 110, 140, 170, 200})[level] + 0.9 * source.bonus_attack_damage end},
  ...
  ["Corki"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 115, 155})[level] + 0.12 * source.ability_power + ({0.15, 0.45, 0.75})[level] * source.total_attack_damage end},
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({160, 230, 300})[level] + 0.24 * source.ability_power + ({0.3, 0.9, 1.5})[level] * source.total_attack_damage end},
  },
  ...
  ["Diana"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({50, 70, 90, 110, 130})[level] + 0.5 * source.ability_power end},	
  ...
  ["Draven"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({40, 45, 50, 55, 60})[level] + (({0.75, 0.85, 0.95, 1,05, 1.15})[level] * source.bonus_attack_damage) end},
  ...
  ["Ekko"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({200, 350, 500})[level] + 1.75 * source.ability_power end}
  },

  ["Elise"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({40, 75, 110, 145, 180})[level] + (0.04 + 0.03 / 100 * source.ability_power) * target.health end},
    {Slot = "Q", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({70, 105, 140, 175, 210})[level] + (0.08 + 0.03 / 100 * source.ability_power) * (target.max_health - target.health) end},
  ...
  ["FiddleSticks"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({750, 1250, 1750})[level] + 2.5 * source.ability_power end},
  },  
  ...
  ["Fizz"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 120, 170, 220, 270})[level] + 0.9 * source.ability_power end},
  ...
  ["Gangplank"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({10, 40, 70, 100, 130})[level] + source.total_attack_damage end},
  ...
  ["Graves"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({275, 425, 575})[level] + 1.5 * source.bonus_attack_damage end},
    {Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({220, 340, 460})[level] + 1.2 * source.bonus_attack_damage end},	
  },
  
  ["Gwen"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({10, 15, 20, 25, 30})[level] + 0.05 * source.ability_power end}, --- noraml dmg each snap
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return 15 + 0.2 * source.ability_power end}, -- Bonus attack dmg for next aa
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({35, 65, 95})[level] + 0.1 * source.ability_power + (((0.008 * source.ability_power / 100) + 0.01) * target.max_health) end}, --First Cast
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({105, 195, 285})[level] + 0.3 * source.ability_power + (((0.024 * source.ability_power / 100) + 0.03) * target.max_health) end}, --Second Cast
    {Slot = "R", Stage = 3, DamageType = 2, Damage = function(source, target, level) return ({175, 325, 475})[level] + 0.5 * source.ability_power + (((0.04 * source.ability_power / 100) + 0.05) * target.max_health) end},	--Third Cast
  },  

  ["Hecarim"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({60, 85, 110, 135, 160})[level] + 0.9 * source.bonus_attack_damage end},
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({20, 30, 40, 50, 60})[level] + 0.2 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 45, 60, 75, 90})[level] + 0.5 * source.bonus_attack_damage end},
  ...
  ["JarvanIV"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({90, 130, 170, 210, 250})[level] + 1.4 * source.bonus_attack_damage end},
  ...
  ["Jayce"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({55, 100, 145, 190, 235, 280})[level] + 1.2 * source.bonus_attack_damage end},
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (({8, 10.8, 13.6, 16.4, 19.2, 22})[level] / 100) * target.max_health + source.bonus_attack_damage end},
  ...
  ["Jinx"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({24, 36, 48})[level] + ({20, 24, 28})[level] / 100 * (target.max_health - target.health) + 0.12 * source.bonus_attack_damage end},
    {Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({300, 450, 600})[level] + ({25, 30, 35})[level] / 100 * (target.max_health - target.health) + 1.5 * source.bonus_attack_damage end},
  },
  
  ["Kaisa"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({40, 55, 70, 85, 100})[level] + 0.3 * source.ability_power + 0.5 * source.bonus_attack_damage end},	
  ...
  ["Katarina"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({20, 35, 50, 65, 80})[level] + 0.25 * source.ability_power + 0.4 * source.total_attack_damage end},   
	...
	{Slot = "R", Stage = 3, DamageType = 1, Damage = function(source, target, level) return (0.16 + 0.16 * source.attack_speed) * source.bonus_attack_damage end}, -- calc for 1 Dagger
  },
  ...
  ["Kayle"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return 0.015 * source.ability_power + ({0.08, 0.085, 0.09, 0.095, 0.10})[level] * (target.max_health - target.health) end},
  ...
  ["Kennen"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 95, 120, 145, 170})[level] + 0.8 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 120, 160, 200, 240})[level] + 0.8 * source.ability_power end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({40, 75, 110})[level] + 0.225 * source.ability_power end},--per Bolt
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({300, 562, 825})[level] + 1.68 * source.ability_power end},--total single target damage	
  },
  ...
  ["KogMaw"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) local dmg = (({0.035, 0.0425, 0.05, 0.0575, 0.065})[level] + (0.01*source.ability_power)) * target.max_health ; if target.is_minion and dmg > 100 then dmg = 100 end ; return dmg end},
  ...
  ["Kled"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 55, 80, 105, 130})[level] + source.bonus_attack_damage * 0.65 end}, --Mounted
  ...
  ["KSante"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({50, 75, 100, 125, 150})[level] + 0.4 * source.total_attack_damage + 0.3 * source.bonus_armor + 0.3 * source.bonus_mr end},
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return KSante_WDmg(source, target) end},
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({35, 70, 105})[level] + 0.2 * source.total_attack_damage end},
	{Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({150, 250, 350})[level] + 0.2 * source.total_attack_damage end},--BonusDmg through terrain
  },  
  ...
  ["Lucian"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({95, 125, 155, 185, 215})[level] + ({0.6, 0.75, 0.9, 1.05, 1.2})[level] * source.bonus_attack_damage end},
  ...
  ["Malphite"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({15, 25, 35, 45, 55})[level] + 0.3 * source.ability_power + 0.15 * source.armor end},
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({200, 300, 400})[level] + 0.9 * source.ability_power end},
  },
  ...
  ["Maokai"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({65, 110, 155, 200, 245})[level] + 0.4 * source.ability_power end},
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({55, 80, 105, 130, 155})[level] + 0.4 * source.ability_power + 0.06 * (source.max_health-source.base_health) end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 225, 300})[level] + 0.75 * source.ability_power end},
  },

  ["MasterYi"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 60, 90, 120, 150})[level] + 0.5 * source.total_attack_damage end},
    {Slot = "E", Stage = 1, DamageType = 3, Damage = function(source, target, level) return ({30, 35, 40, 45, 50})[level] + 0.3 * source.bonus_attack_damage end},
  },

  ["MissFortune"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({20, 45, 70, 95, 120})[level] + 0.35 * source.ability_power + source.total_attack_damage end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 100, 130, 160, 190})[level] + 1.2 * source.ability_power end},
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return 0.75 * source.total_attack_damage + 0.25 * source.ability_power end},
  },
  ...
  ["Nilah"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({5, 10, 15, 20, 25})[level] + (({0.9, 1, 1.1, 1.2, 1.3})[level] * source.total_attack_damage) end},	
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({60, 90, 115, 140, 165})[level] + 0.2 * source.total_attack_damage end},
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({15, 30, 45})[level] + 0.35 * source.bonus_attack_damage end}, --Per Tick
    {Slot = "R", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({125, 225, 325})[level] + 1.2 * source.bonus_attack_damage end}, --Burst Dmg	
  },  
  ...
  ["Nunu"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({625, 950, 1275})[level] + 3 * source.ability_power end},
  },

  ["Olaf"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({70, 120, 170, 220, 270})[level] + source.bonus_attack_damage end},
  ...
  ["Rakan"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 115, 160, 205, 250})[level] + 0.7 * source.ability_power end},
  ...
  ["Renekton"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({60, 90, 120, 150, 180})[level] + source.bonus_attack_damage end},
    {Slot = "Q", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({90, 135, 180, 225, 270})[level] + 1.4 * source.bonus_attack_damage end},--REIGN OF ANGER	
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({25, 50, 75})[level] + 0.05 * source.ability_power + 0.05 * source.bonus_attack_damage end},--per Tick
  },
  ...
  ["Ryze"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 90, 110, 130, 150})[level] + 0.55 * source.ability_power end},
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 110, 140, 170, 200})[level] + 0.7 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 90, 120, 150, 180})[level] + 0.45 * source.ability_power  end},
  },
  
  ["Samira"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({0, 5, 10, 15, 20})[level] + ({0.85, 0.95, 1.05, 1.15, 1.25})[level] * source.total_attack_damage end},
  ...
  ["Sett"] = {
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({80, 100, 120, 140, 160})[level] + 0.25 * source.bonus_attack_damage end}, -- without expended Grit
    {Slot = "W", Stage = 2, DamageType = 3, Damage = function(source, target, level) return ({80, 100, 120, 140, 160})[level] + 0.25 * source.bonus_attack_damage end}, -- True Damage without expended Grit
  ...
  ["Shaco"] = {
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({10, 15, 20, 25, 30})[level] + 0.12 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return (GetPercentHP(target) < 30 and ({105, 142, 180, 217, 255})[level] + 0.9 * source.ability_power + 1.125 * source.bonus_attack_damage or ({70, 95, 120, 145, 170})[level] + 0.6 * source.ability_power + 0.75 * source.bonus_attack_damage) end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 225, 300})[level] + 0.7 * source.ability_power end},
  },
  ...
  ["Shyvana"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({10, 16, 22, 28, 35})[level] + 0.15 * source.bonus_attack_damage end},--per tick
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 100, 140, 180, 220})[level] + 0.9 * source.ability_power + 0.4 * source.total_attack_damage end},
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 350})[level] + 1.3 * source.ability_power end},
  },
  ...
  ["Sivir"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({15, 30, 45, 60, 75})[level] + ({80, 85, 90, 95, 100})[level] / 100 * source.total_attack_damage + 0.6 * source.ability_power end},
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({0.25, 0.3, 0.35, 0.4, 0.45})[level] * source.total_attack_damage end},
  },
  ...
  ["Sona"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({50, 80, 110, 140, 170})[level] + 0.4 * source.ability_power end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({150, 250, 350})[level] + 0.5 * source.ability_power end},
  },
  ...
  ["Swain"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 115, 150, 185, 220})[level] + 0.55 * source.ability_power end},
  ...
  ["Syndra"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 105, 140, 175, 210})[level] + 0.7 * source.ability_power end},
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 110, 150, 190, 230})[level] + 0.7 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({75, 115, 155, 195, 235})[level] + 0.55 * source.ability_power end},
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({270, 390, 510})[level] + 0.51 * source.ability_power end},
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({90, 130, 170})[level] + 0.17 * source.ability_power end},-- PER SPHERE
  },
  ...
  ["Taliyah"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({45, 65, 85, 105, 125})[level] + 0.5 * source.ability_power end},
    {Slot = "Q", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({117, 169, 221, 273, 325})[level] + 1.3 * source.ability_power end},--Single Target
  ...
  ["TahmKench"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 130, 180, 230, 280})[level] + 0.9 * source.ability_power end},
    ...
    {Slot = "W", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({100, 135, 170, 205, 240})[level] + 1.25 * source.ability_power end},--PROJECTILE DAMAGE
  },
  ...
  ["Teemo"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({200, 325, 450})[level] + 0.55 * source.ability_power end},
  },

  ["Thresh"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({100, 140, 180, 220, 260})[level] + 0.5 * source.ability_power end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({75, 110, 145, 180, 215})[level] + 0.4 * source.ability_power end},
  ...
  ["TwistedFate"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 100, 140, 180, 220})[level] + 0.8 * source.ability_power end},
  ...
  ["Twitch"] = {
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return (GotBuff(target, "twitchdeadlyvenom") * ({15, 20, 25, 30, 35})[level] + 0.35 * source.ability_power + 0.35 * source.bonus_attack_damage) + ({20, 30, 40, 50, 60})[level] end},
  },
  ...
  ["Udyr"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 144, 208, 272, 336, 400})[level] + 1.4 * source.ability_power end},
  ...
  ["Varus"] = {
    ...
    {Slot = "W", Stage = 2, DamageType = 2, Damage = function(source, target, level) return (({3, 3.5, 4, 4.5, 5})[level] / 100 + 0.025 * source.ability_power / 100) * target.max_health end},
  ...
  ["Vayne"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 3, Damage = function(source, target, level) return ({50, 65, 80, 95, 110})[level] + (({0.04, 0.06, 0.08, 0.10, 0.12})[level] * target.max_health) end},
  ...
  ["Vex"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 105, 150, 195, 240})[level] + 0.7 * source.ability_power end},
  ...
  ["Viego"] = {
    ...
    {Slot = "R", Stage = 1, DamageType = 1, Damage = function(source, target, level) return (({0.12, 0.16, 0.20})[level] + 0.03 * (source.bonus_attack_damage / 100) * (target.max_health - target.health)) + 1.2 * source.total_attack_damage + source.crit_chance end},
  },  
  ...
  ["Volibear"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({10, 30, 50, 70, 90})[level] + 1.2 * source.bonus_attack_damage end},
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return (({5, 30, 55, 80, 105})[level]) + source.total_attack_damage + 0.05 * (source.max_health - GetBaseHealth(source)) end},
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({80, 110, 140, 170, 200})[level] + 0.8 * source.ability_power + ({0.09, 0.1, 0.11, 0.12, 0.13})[level] * target.max_health end}, --Hero Dmg
  ...
  ["XinZhao"] = {
    ...
    {Slot = "W", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({50, 85, 120, 155, 190})[level] + 0.9 * source.total_attack_damage + 0.65 * source.ability_power end},	
  ...
  ["Yuumi"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({50, 90, 130, 170, 210, 250})[level] + 0.3 * source.ability_power end},
  ...
  ["Zeri"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({1.14, 1.57, 2, 2.43, 2.86})[level] + (({0.15, 0.1571, 0.1643, 0.1714, 0.1786})[level] * source.total_attack_damage) end}, -- per bullet
    {Slot = "Q", Stage = 2, DamageType = 1, Damage = function(source, target, level) return ({8, 11, 14, 17, 20})[level] + (({1, 1.05, 1.1, 1.15, 1.2})[level] * source.total_attack_damage) end}, -- Full Dmg
    {Slot = "W", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({20, 55, 90, 125, 160})[level] + source.total_attack_damage + 0.4 * source.ability_power end},
  ...
  ["Ziggs"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({95, 145, 195, 245, 295})[level] + 0.65 * source.ability_power end},
  ...
  ["Zoe"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 110, 150, 190, 230})[level] + 0.45 * source.ability_power end},
  },  
