...
local DamageLibTable = {
  ...
  ["Akshan"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({30, 50, 70, 90, 110})[level] + 0.175 * source.bonus_attack_damage + 0.3 * source.bonus_attack_speed end}, -- per Shot
  ...
  ["Amumu"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({70, 100, 130, 160, 190})[level] + 0.85 * source.ability_power end},
  ...
  ["Fizz"] = {
    ...
    {Slot = "R", Stage = 2, DamageType = 2, Damage = function(source, target, level) return ({200, 275, 350})[level] + 0.85 * source.ability_power end},
    {Slot = "R", Stage = 3, DamageType = 2, Damage = function(source, target, level) return ({250, 325, 400})[level] + source.ability_power end},
  },
  ...
  ["Qiyana"] = {
    ...
    {Slot = "E", Stage = 1, DamageType = 1, Damage = function(source, target, level) return ({50, 80, 110, 140, 170})[level] + 0.7 * source.bonus_attack_damage end},
  ...
  ["Vex"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, Damage = function(source, target, level) return ({60, 110, 160, 210, 260})[level] + 0.6 * source.ability_power end},
  ...
  ["Viego"] = {
    {Slot = "Q", Stage = 1, DamageType = 1, Damage = function(source, target, level) return (({15, 30, 45, 60, 75})[level] + 0.6 * source.total_attack_damage) * source.crit_chance end},
